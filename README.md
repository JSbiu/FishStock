...
0.4.10 是 0.4 系列的维护修订版本，主题是可信与顺手，当前支持 A 股、港股、市场指数和国内商品期货。
...
- 股票、指数使用腾讯公开网页行情端点；国内商品期货使用新浪公开网页行情端点。两者都没有面向 FishStock 的正式接口契约，字段或访问策略可能变化。任一行情源返回 HTTP 403 后，对应模块的自动刷新按 15 分钟、30 分钟、1 小时、2 小时、最长 6 小时递增退避；手动刷新始终可以立即重新探测。
- 股票与期货后台刷新分别按内置的 2024–2026 年 A 股与 2025–2026 年港股节假日数据判断当天是否交易；2027 年及以后未公布安排回退为按工作日判断，待交易所公布后随版本更新。当前只暂停非交易日，不按午休、收盘或期货分品种夜盘时段暂停；临时休市（如恶劣天气）仍只能依据行情日期显示。
